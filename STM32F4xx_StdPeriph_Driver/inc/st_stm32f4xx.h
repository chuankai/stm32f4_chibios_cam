...
#ifndef __ST_STM32F4xx_H
#define __ST_STM32F4xx_H
...
#if !defined (STM32F4XX)
 #error "Please select first the target STM32F4XX device used in your application (in st_stm32f4xx.h file)"
#endif
...
#define GPIOA               ((ST_GPIO_TypeDef *) GPIOA_BASE)
#define GPIOB               ((ST_GPIO_TypeDef *) GPIOB_BASE)
#define GPIOC               ((ST_GPIO_TypeDef *) GPIOC_BASE)
#define GPIOD               ((ST_GPIO_TypeDef *) GPIOD_BASE)
#define GPIOE               ((ST_GPIO_TypeDef *) GPIOE_BASE)
#define GPIOF               ((ST_GPIO_TypeDef *) GPIOF_BASE)
#define GPIOG               ((ST_GPIO_TypeDef *) GPIOG_BASE)
#define GPIOH               ((ST_GPIO_TypeDef *) GPIOH_BASE)
#define GPIOI               ((ST_GPIO_TypeDef *) GPIOI_BASE)
